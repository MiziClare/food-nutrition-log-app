        ...
        >
            ...
            >
                {showCamera ? (
                    <Fade in>
                        <Box
                            sx={{ width: "100%", maxWidth: 640, textAlign: "center", mb: 15 }}
                        >
                            <motion.div
            ...
            <Fade in timeout={800}>
                ...
                >
                    {showCamera ? (
                        /* Camera mode: Cancel and Capture buttons */
                        <>
                            <motion.div
                            ...
                            >
                                ...
                                >
                                    <CameraOutlined style={{ fontSize: 40, color: "#667eea" }} />
                                </IconButton>
                            </motion.div>
                            <motion.div
                        ...
                        /* Initial mode: Camera and Upload buttons */
                        <>
                            <motion.div
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                    ...
                    {/* Image selected and meal type chosen: Show confirm button */}
                    {selectedImage && selectedMealType && !showCamera && (
                        <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
